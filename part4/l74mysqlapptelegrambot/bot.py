...
#     await update.message.reply_text(f'Welcome! Please enter your Full Name : ')
#     return FULLNAME

# # Temp Save FULLNAME and Ask for EMAIL 
# async def fullname(update: Update, context: ContextTypes.DEFAULT_TYPE):
#     context.user_data["fullname"] = update.message.text
#     await update.message.reply_text(f'Welcome! Please enter your Email : ')
#     return EMAIL
...
#         await update.message.reply_text('Full Name cannot be empty!, Please restart with /start and enter a vaild full name.')
#         return ConversationHandler.END

#     if not email or email.strip() == "" 
#         await update.message.reply_text('Email cannot be empty!, Please restart with /start and enter a vaild email.')
#         return ConversationHandler.END


#     insert_sql = "INSERT INTO employees(fullname,email) VALUES (%s,%s)"
...
async def email(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if conn.is_connected():
        ...
        try: 
            ...
            if e.errno == 1062:
                await update.message.reply_text('That email already exists. Please try again with a different one.')
            else: 
