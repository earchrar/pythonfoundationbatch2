...
class TaskJob:
    ...
    def listtasks(self):
        ...
        for idx,task in enumerate(self.tasks):
            ...
            print(f"{idx+1}. {task.title} , ( Priority : {task.priority} ) {status}")
    ...
    def tasksreports(self):
        ...
        hightprioritiescount = reduce(lambda x,y: x+(1 if y.priority >= 5 else 0),self.tasks,0)
        print(f"Total hight priority tasks (over 4) : {hightprioritiescount}")
