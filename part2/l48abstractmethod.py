...
class Teacher(Employee):
    ...
    # def getrole(self):
    #     return "Teacher" # Teacher ( id disabled ! result = Employee )
...
def main() -> None:
        ...
        employee: Employee = Employee("Linn Linn",45,"EM2002","HR")
        teacher: Teacher = Teacher("Linn Linn",45,"EM2002","Mathematics","MathII")

        print(student.showinfo()) # Student : Hnin Hnin , Age : 18 , ID : ST1001 , Major : Computer Science
        print(student.getrole()) # Student

        print(employee.showinfo()) # Employee : Linn Linn , Age : 45 , ID : EM2002 , Department : HR
        print(employee.getrole()) # Employee

        print(teacher.showinfo()) # Teacher : Linn Linn , Age : 45 , ID : EM2002 , Department : Mathematics , Subject : MathII
        print(teacher.getrole()) # Teacher ( if comment ! result is Employee )
...
class RoleManager:
    ...
    def addperson(self,person):
        if not isinstance(person,Person):
            raise TypeError("Only Person subclasses can be added.")
...
rolemanagerObj.addperson(Student("Nilar",20,"ST1002","Physics"))                # Student 
rolemanagerObj.addperson(Employee("Malar",30,"EM2003","Marketing"))             # Employee 
rolemanagerObj.addperson(Teacher("Kyipar",50,"TR3004","Science","Biology"))     # Employee
rolemanagerObj.addperson(Staff("Muyar",55,"EM2004","Marketing"))                # Employee

rolemanagerObj.displayall()

print(f"Number of students : {rolemanagerObj.countbyrole('Student')}")
print(f"Number of employee : {rolemanagerObj.countbyrole('Employee')}")
